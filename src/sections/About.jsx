...
const About = () => {
    ...
    const handleCopy =()=>{
        navigator.clipboard.writeText('thehonouredone@gmail.com');
        setHasCopied(true);
        setTimeout(()=>{
            setHasCopied(false)
        },2000)
                ...
                <div className="grid-container">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="copy-container" onClick={handleCopy}>
                            ...
                            <p className='lg:text-xl md:text-xl font-medium text-gray_gradient text-white'>thehonouredone@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
